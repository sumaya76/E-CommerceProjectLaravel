    ...
    <div class="page-content">
      <div class="page-header">
        <div class="container-fluid">
          <div class="design">
            <h2>Add Category</h2>
            <form action="{{ url('add_category') }}" method="post" style="display: flex; justify-content: center; margin-top:0.1875rem;"> <!-- 3px -> 0.1875rem -->
                @csrf
                <div class="input-group mb-3">
                    <input type="text" name="category" class="form-control" placeholder="Write the category name..">
